...
// Boss ednums by difficulty. The Spider Mastermind's 128-unit radius cannot
// safely occupy the center of a 256-unit coarse cell, so heavyweight finales
// use the substantially smaller Cyberdemon after arena-capacity validation.
