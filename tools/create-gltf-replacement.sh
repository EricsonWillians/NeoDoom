...
5. **Test in BiasedDoom:**
   \`\`\`bash
   biaseddoom -file MyMod.pk3
   \`\`\`
...
From the BiasedDoom repository root:

- `docs/gltf/quick-start.md`
- `docs/gltf/blender-authoring.md`
- `docs/gltf/zscript-api.md`
- `docs/development/gltf-implementation.md`
...
Generated by BiasedDoom glTF Model Replacement Generator v2.0
EOF
}
...
main() {
    ...
    if [ ! -f "$PROJECT_ROOT/CMakeLists.txt" ]; then
        print_warning "Not in BiasedDoom project root. Script will create files in current directory."
        PROJECT_ROOT="$(pwd)"
    fi
    ...
    echo ""
    echo -e "4. ${CYAN}Test in BiasedDoom:${NC}"
    echo -e "   ${YELLOW}biaseddoom -file ${class_name}.pk3${NC}"
    echo ""
    echo -e "${BOLD}Documentation:${NC}"
    echo -e "  - Model guide:   ${BLUE}$PROJECT_ROOT/docs/gltf/blender-authoring.md${NC}"
    echo -e "  - ZScript API:   ${BLUE}$PROJECT_ROOT/docs/gltf/zscript-api.md${NC}"
